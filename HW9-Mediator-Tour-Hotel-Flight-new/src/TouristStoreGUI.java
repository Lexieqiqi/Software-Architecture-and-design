...
public class TouristStoreGUI extends JFrame implements ParticipantGUI {
	...
	public static final String TouristStore = "touristStore";
	...
	public TouristStoreGUI(BusinessMediator bMdtr) {
		super("Mediator Pattern- Tourist Store ");
		bMediator = bMdtr;
		setUpChoicePanel();
		setUpScrollPanes();
	...
	private void setUpScrollPanes() {
		...
		bigSplitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, btnPanel,
				showInfoPane);
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent ae) {
			...
			if (ae.getActionCommand().equals(SUBMIT)) {
				...
				addCustomer(cusInfo);
				bMediator.addPossibleCus(TouristStore, cusInfo);
				bMediator.updateALlGuis(TouristStore, cusInfo);
			}
		}
	}
}
